...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2016 at 05:51 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='เก็บหมวดหมู่สินค้า' AUTO_INCREMENT=8 ;
...
`menufac_id` int(5) NOT NULL,
  `menufacname` varchar(100) NOT NULL,
  `status` int(2) NOT NULL
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='เก็บผู้ผลิต' AUTO_INCREMENT=13 ;

--
-- Dumping data for table `manufacturer`
--

INSERT INTO `manufacturer` (`menufac_id`, `menufacname`, `status`) VALUES
(1, 'Berkley Trade', 0),
(2, 'Disney Toys', 0),
(3, 'LEGO', 0),
(4, 'adidas', 0),
...
INSERT INTO `member` (`id`, `fullname`, `email`, `password`, `tel`, `address`, `status`) VALUES
(1, 'Samit Koyom', 'samitkoyom@gmail.com', '123456', '089839839', '2 Ladrpao 65 สะพานสอง วังทองหลาง กทม. 10310', 1),
(2, 'สามิตร โกยม', 'samit@hotmail.com', '112233', '0897307830783', '2 ลาดพร้าว 65/1 สะพานสอง วังทองหลาง กทม. 10310', 1);
...
`prd_id` int(5) NOT NULL,
  ...
  `menufac_id` int(5) NOT NULL,
  `status` int(2) NOT NULL
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดสินค้า' AUTO_INCREMENT=22 ;
...
`id` int(5) NOT NULL,
  ...
  `imgtype` varchar(64) NOT NULL,
  `imgsize` varchar(64) NOT NULL
...
INSERT INTO `upload_img` (`id`, `imgname`, `imgtype`, `imgsize`) VALUES
(17, '0_huadojghf6cchb2g06ot2hnfrcgaqfe5.jpg', 'image/jpeg', '40909'),
(18, '1_vxbl612orqw9itdhjp086arl19mf0zoo.jpg', 'image/jpeg', '50036'),
(19, '2_rcyoyo42bbz5x30h47jpd159xsr8y47w.jpg', 'image/jpeg', '36235'),
(20, '3_1ovq45fyt7ibktuuwyimzaxgwi5ohu70.jpg', 'image/jpeg', '66124'),
(21, '4_nsygf705spkif0cug3qb1draqlv93ple.jpg', 'image/jpeg', '31666'),
(22, '5_j2pnmbeycey9w9z57rtt1hu5nm0svji8.jpg', 'image/jpeg', '21429'),
(23, '0_nda5qyebkhp2x67y138g5wfwm1mxo3dp.jpg', 'image/jpeg', '74755'),
(24, '1_i9gzuol4mldqhlrg1sadcaoodurhkcl6.jpg', 'image/jpeg', '50982'),
(25, '2_znouq0wygvbbkrm8s91foapxj4qgdulw.jpg', 'image/jpeg', '365507'),
(26, '0_ayydm4mjgaj141t8v7nl2tjnx7auokl6.jpg', 'image/jpeg', '40909'),
(27, '0_orh5dz6favkfbcpb5f6eartcs2r2ljlf.jpg', 'image/jpeg', '19223');
...
--
ALTER TABLE `manufacturer`
MODIFY `menufac_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `product`
MODIFY `prd_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
